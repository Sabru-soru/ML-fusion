...
plt.plot(new_graph_data_xgb_simple['x_m'], new_graph_data_xgb_simple['Predicted_Pot'], label='Predicted Pot XGB Simple', linestyle='--')
plt.plot(list(predictions5000.keys()), list(predictions5000.values()), label='Predicted Pot separate x_m')
plt.xlabel('x_m [m]')
plt.ylabel('Pot')
...
#plot new_Ivona data and new_graph_data and fill between them
plt.figure(figsize=(12, 6))
plt.plot(new_Ivona['x_m'], new_Ivona['Pot'], label='Actual Pot')
plt.plot(new_graph_data['x_m'], new_graph_data['Predicted_Pot'], label='Predicted Pot')
plt.fill_between(new_graph_data['x_m'], new_graph_data['Predicted_Pot']-mae, new_graph_data['Predicted_Pot']+mae, alpha=0.3)
plt.xlabel('x_m [m]')
plt.ylabel('Pot')
plt.title('Comparison')
plt.legend()
...
"""
Below are tests for changing one parameter
"""
