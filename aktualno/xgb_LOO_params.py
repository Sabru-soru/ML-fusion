...
#%%
for parameter in ['Ti','Vi','Vn','nn','E','Ve']:
    
    prediction_parameter = parameter
    print(prediction_parameter)
    y = df[prediction_parameter]
    ...
    pd.DataFrame(overall_results_sorted).to_csv(f'data/xgb_LOO_results_{prediction_parameter}.csv', index=False)
# %%
